...
export const DS160_SECTIONS: Ds160Section[] = [
  {
    ...
    campos: [
      ...
      { key: "outro_nome_sobrenome", label: "Já teve outro nome e sobrenome utilizados antes do atual", kind: "text", optional: true, help: "Casamentos e divórcios podem alterar o sobrenome.", showIf: (d) => SIM_NAO(d, "usou_outros_nomes") },
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "outra_nacionalidade_pais", label: "Informe sua outra Nacionalidade", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "outra_nacionalidade") },
      { key: "outra_nacionalidade_passaporte", label: "Possui um passaporte para essa outra Nacionalidade", kind: "bool", optional: true, showIf: (d) => SIM_NAO(d, "outra_nacionalidade") },
      { key: "outra_nacionalidade_passaporte_numero", label: "Informe o Número desse Passaporte", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "outra_nacionalidade") && SIM_NAO(d, "outra_nacionalidade_passaporte") },
      ...
      { key: "residente_permanente_pais", label: "Informe", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "residente_permanente") },
  ...
  },
  {
    ...
    campos: [
      ...
      {
        key: "categoria_estudante", label: "Especifique a Categoria Estudante", kind: "select", optional: true,
      ...
      { key: "destino_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => d.onde_ficara === "Casa Particular" || d.onde_ficara === "Casa Alugada" },
      { key: "destino_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => d.onde_ficara === "Casa Particular" || d.onde_ficara === "Casa Alugada" },
      { key: "destino_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => d.onde_ficara === "Casa Particular" || d.onde_ficara === "Casa Alugada" },
      { key: "destino_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => d.onde_ficara === "Casa Particular" || d.onde_ficara === "Casa Alugada" },
      { key: "destino_endereco_cep", label: "Código postal", kind: "text", optional: true, showIf: (d) => d.onde_ficara === "Casa Particular" || d.onde_ficara === "Casa Alugada" },
      { key: "destino_endereco_pais", label: "País", kind: "text", optional: true, showIf: (d) => d.onde_ficara === "Casa Particular" || d.onde_ficara === "Casa Alugada" },
    ],
  },
  {
    id: "pagador",
    ...
    campos: [
      ...
      { key: "pagador_pessoa_nome", label: "Nome e sobrenome da pessoa", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER PERSON" },
      { key: "pagador_pessoa_telefone", label: "Telefone da pessoa com DDD", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER PERSON" },
      { key: "pagador_pessoa_email", label: "E-mail da pessoa", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER PERSON" },
      { key: "pagador_pessoa_parentesco", label: "Qual o seu parentesco com a pessoa que vai pagar a viagem?", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER PERSON" },
      {
        key: "pagador_pessoa_endereco_tipo", label: "Endereço completo de quem vai pagar a viagem", kind: "select", optional: true,
      ...
      { key: "pagador_pessoa_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => d.pagador_pessoa_endereco_tipo === "Outro endereço" },
      { key: "pagador_pessoa_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => d.pagador_pessoa_endereco_tipo === "Outro endereço" },
      { key: "pagador_pessoa_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => d.pagador_pessoa_endereco_tipo === "Outro endereço" },
      { key: "pagador_pessoa_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => d.pagador_pessoa_endereco_tipo === "Outro endereço" },
      { key: "pagador_pessoa_endereco_cep", label: "Código postal", kind: "text", optional: true, showIf: (d) => d.pagador_pessoa_endereco_tipo === "Outro endereço" },
      { key: "pagador_pessoa_endereco_pais", label: "País", kind: "text", optional: true, showIf: (d) => d.pagador_pessoa_endereco_tipo === "Outro endereço" },
      { key: "pagador_empresa_nome", label: "Nome da empresa", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_telefone", label: "Número de telefone da empresa com DDD", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_relacionamento", label: "Qual o relacionamento da empresa com você?", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_endereco_cep", label: "Código postal", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
      { key: "pagador_empresa_endereco_pais", label: "País", kind: "text", optional: true, showIf: (d) => d.quem_paga === "OTHER COMPANY/ORGANIZATION" },
    ],
  },
  {
    id: "companheiros",
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "carteira_habilitacao_eua_detalhe", label: "Informe os dados da sua Habilitação Americana", kind: "textarea", optional: true, help: "Todos os dados de como está o nome e números referentes à sua Habilitação Americana.", showIf: (d) => SIM_NAO(d, "carteira_habilitacao_eua") },
      ...
      { key: "visto_anterior_numero", label: "Número do visto (descrito em vermelho)", kind: "text", optional: true, help: "Caso não saiba o número, escreva \"NÃO SEI\".", showIf: (d) => SIM_NAO(d, "ja_teve_visto_eua") },
      { key: "visto_mesmo_tipo", label: "Você está solicitando o mesmo tipo de visto?", kind: "bool", optional: true, showIf: (d) => SIM_NAO(d, "ja_teve_visto_eua") },
      { key: "visto_perdido_roubado", label: "Seu visto americano já foi perdido ou roubado?", kind: "bool", optional: true, showIf: (d) => SIM_NAO(d, "ja_teve_visto_eua") },
      { key: "visto_perdido_roubado_ano", label: "Digite o ano em que o visto foi perdido ou roubado", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "ja_teve_visto_eua") && SIM_NAO(d, "visto_perdido_roubado") },
      { key: "visto_perdido_roubado_explique", label: "Explique", kind: "textarea", optional: true, showIf: (d) => SIM_NAO(d, "ja_teve_visto_eua") && SIM_NAO(d, "visto_perdido_roubado") },
      { key: "visto_cancelado_revogado", label: "Seu visto já foi cancelado ou revogado?", kind: "bool" },
      { key: "visto_cancelado_revogado_explique", label: "Explique o motivo do cancelamento ou revogação", kind: "textarea", optional: true, showIf: (d) => SIM_NAO(d, "visto_cancelado_revogado") },
      ...
      { key: "visto_recusado_explique", label: "Descreva com detalhes sobre a recusa ou negativa de entrada nos Estados Unidos", kind: "textarea", optional: true, showIf: (d) => SIM_NAO(d, "visto_recusado") },
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "rede_social_1_handle", label: "Descreva aqui endereço da sua Rede Social", kind: "text", optional: true, showIf: (d) => d.rede_social_1 === "Instagram" || d.rede_social_1 === "Facebook" || d.rede_social_1 === "Linkedin" },
      {
        key: "rede_social_2", label: "Sua segunda Rede Social?", kind: "select", optional: true,
        help: "Se não tiver, selecione Nenhuma.",
        options: ["Nenhuma", "Instagram", "Facebook", "Linkedin"].map((v) => ({ value: v, label: v })),
      },
      { key: "rede_social_2_handle", label: "Descreva aqui endereço da sua Rede Social", kind: "text", optional: true, showIf: (d) => d.rede_social_2 === "Instagram" || d.rede_social_2 === "Facebook" || d.rede_social_2 === "Linkedin" },
    ],
  },
  {
    id: "passaporte",
    ...
    campos: [
      ...
      { key: "passaporte_tipo_outro", label: "Descreva outros", kind: "text", optional: true, showIf: (d) => d.passaporte_tipo === "Outros" },
      ...
      { key: "passaporte_pais_emissor_outro", label: "Descreva outros", kind: "text", optional: true, showIf: (d) => d.passaporte_pais_emissor === "Outros" },
      ...
      { key: "passaporte_perdido_roubado_explique", label: "Explique sobre o documento perdido ou roubado", kind: "textarea", optional: true, showIf: (d) => SIM_NAO(d, "passaporte_perdido_roubado") },
    ],
  },
  {
    id: "contato_eua",
    ...
    campos: [
      ...
      { key: "contato_eua_nome", label: "Nome completo da pessoa ou empresa", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_telefone", label: "Telefone da pessoa ou empresa", kind: "text", optional: true, help: "Preencha corretamente este campo.", showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_email", label: "E-mail da pessoa ou empresa", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_endereco_cep", label: "Código postal", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      { key: "contato_eua_endereco_pais", label: "País", kind: "text", optional: true, showIf: (d) => d.contato_eua_tipo === "Sim, conheço uma Pessoa" || d.contato_eua_tipo === "Sim, conheço uma Empresa" },
      {
        key: "contato_eua_relacao", label: "Qual sua Relação com pessoa ou empresa citada acima?", kind: "select", optional: true,
      ...
      { key: "contato_eua_relacao_detalhe", label: "Descreva sua relação com a pessoa ou a empresa?", kind: "textarea", optional: true, showIf: (d) => d.contato_eua_relacao === "Outro" },
    ],
  },
  {
    id: "familia",
    ...
    campos: [
      ...
      { key: "pai_situacao_eua", label: "Situação do seu Pai nos Estados Unidos", kind: "select", optional: true, showIf: (d) => SIM_NAO(d, "pai_esta_eua"), options: SITUACAO_EUA_OPCOES },
      { key: "pai_situacao_eua_explique", label: "Explique", kind: "textarea", optional: true, showIf: (d) => d.pai_situacao_eua === "Outro" },
      ...
      { key: "mae_situacao_eua", label: "Situação da sua Mãe nos Estados Unidos", kind: "select", optional: true, showIf: (d) => SIM_NAO(d, "mae_esta_eua"), options: SITUACAO_EUA_OPCOES },
      { key: "mae_situacao_eua_explique", label: "Explique", kind: "textarea", optional: true, showIf: (d) => d.mae_situacao_eua === "Outro" },
      { key: "parente_1_grau_eua", label: "Você tem algum parente de primeiro grau, sem incluir os Pais, nos EUA?", kind: "bool", optional: true },
      { key: "parente_1_grau_nome", label: "Nome Completo do Parente Imediato", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "parente_1_grau_eua") },
      {
        key: "parente_1_grau_parentesco", label: "Informe abaixo o Grau de Parentesco", kind: "select", optional: true,
        showIf: (d) => SIM_NAO(d, "parente_1_grau_eua"),
        options: ["Noivo / Noiva", "Cônjuge", "Filho / Filha", "Irmão / Irmã"].map((v) => ({ value: v, label: v })),
      },
      { key: "parente_1_grau_situacao", label: "Situação do parente nos Estados Unidos", kind: "select", optional: true, showIf: (d) => SIM_NAO(d, "parente_1_grau_eua"), options: SITUACAO_EUA_OPCOES },
      { key: "outro_parente_eua", label: "Você tem algum outro parente nos Estados Unidos?", kind: "bool" },
      { key: "outro_parente_eua_parentesco", label: "Descreva o Grau de parentesco", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "outro_parente_eua") },
    ],
  },
  {
    id: "conjuge",
    ...
    campos: [
      { key: "conjuge_nome", label: "Nome Completo do Cônjuge", kind: "text", optional: true, showIf: (d) => d.estado_civil === "MARRIED" },
      { key: "ex_parceiro_nome", label: "Nome Completo do Ex Parceiro(a)", kind: "text", optional: true, showIf: (d) => d.estado_civil === "DIVORCED" || d.estado_civil === "LEGALLY SEPARATED" },
      { key: "conjuge_falecido_nome", label: "Nome Completo do Cônjuge Falecido(a)", kind: "text", optional: true, showIf: (d) => d.estado_civil === "WIDOWED" },
      { key: "conjuge_data_nascimento", label: "Data Nascimento", kind: "date", optional: true, showIf: (d) => d.estado_civil === "MARRIED" || d.estado_civil === "DIVORCED" || d.estado_civil === "LEGALLY SEPARATED" || d.estado_civil === "WIDOWED" },
      { key: "conjuge_nacionalidade", label: "Nacionalidade (País de Origem)", kind: "text", optional: true, showIf: (d) => d.estado_civil === "MARRIED" || d.estado_civil === "DIVORCED" || d.estado_civil === "LEGALLY SEPARATED" || d.estado_civil === "WIDOWED" },
      { key: "conjuge_cidade_nascimento", label: "Cidade de Nascimento do Cônjuge", kind: "text", optional: true, showIf: (d) => d.estado_civil === "MARRIED" || d.estado_civil === "DIVORCED" || d.estado_civil === "LEGALLY SEPARATED" || d.estado_civil === "WIDOWED" },
      { key: "data_casamento", label: "Data do Casamento", kind: "date", optional: true, showIf: (d) => d.estado_civil === "DIVORCED" || d.estado_civil === "LEGALLY SEPARATED" },
      { key: "data_divorcio", label: "Data do Divórcio", kind: "date", optional: true, showIf: (d) => d.estado_civil === "DIVORCED" || d.estado_civil === "LEGALLY SEPARATED" },
    ],
  },
  {
    id: "trabalho_atual",
    ...
    campos: [
      ...
      { key: "cargo", label: "Informe seu cargo ou escolaridade", kind: "text", optional: true, showIf: (d) => d.ocupacao_atual === "Funcionário" || d.ocupacao_atual === "Estudante" },
      { key: "trabalho_data_inicio", label: "Data de Início no trabalho ou estudo", kind: "date", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra", "Estudante"].includes(String(d.ocupacao_atual)) },
      { key: "trabalho_funcoes", label: "Descreva abaixo suas funções diárias no trabalho", kind: "textarea", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra"].includes(String(d.ocupacao_atual)) },
      { key: "trabalho_empresa_nome", label: "Nome completo da empresa onde trabalha ou instituição de ensino", kind: "text", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra", "Estudante"].includes(String(d.ocupacao_atual)) },
      { key: "trabalho_telefone", label: "DDD+Telefone", kind: "text", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra", "Estudante"].includes(String(d.ocupacao_atual)) },
      { key: "trabalho_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra", "Estudante"].includes(String(d.ocupacao_atual)) },
      { key: "trabalho_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra", "Estudante"].includes(String(d.ocupacao_atual)) },
      { key: "trabalho_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra", "Estudante"].includes(String(d.ocupacao_atual)) },
      { key: "trabalho_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => ["Empresário / Empreendedor / Dono Próprio Negócio", "Funcionário", "Outra", "Estudante"].includes(String(d.ocupacao_atual)) },
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "trabalho_anterior_empresa_nome", label: "Nome Completo da Empresa Anterior", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      ...
      { key: "trabalho_anterior_supervisor", label: "Nome Completo do Supervisor", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_telefone", label: "Telefone com DDD (00) 0000-0000", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_endereco_cep", label: "Código postal", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_endereco_pais", label: "País", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_data_inicio", label: "Data Início", kind: "date", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_data_fim", label: "Data Saída", kind: "date", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior_funcoes", label: "Descreva Brevemente suas Funções", kind: "textarea", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") },
      { key: "trabalho_anterior2_empresa_nome", label: "Nome da Empresa Anterior 2", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_cargo", label: "Cargo Anterior", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_supervisor", label: "Nome Completo do Supervisor", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_telefone", label: "Telefone com DDD (00) 0000-0000", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_endereco_cep", label: "Código postal", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
      { key: "trabalho_anterior2_endereco_pais", label: "País", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "trabalhou_outra_empresa_5anos") && !!d.trabalho_anterior_empresa_nome },
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "instituicao_nome", label: "Nome Completo da Instituição", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "estudou_nivel_medio_superior") },
      { key: "instituicao_telefone", label: "Telefone com DDD (00) 0000-0000", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "estudou_nivel_medio_superior") },
      { key: "instituicao_endereco_rua", label: "Rua", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "estudou_nivel_medio_superior") },
      { key: "instituicao_endereco_bairro", label: "Bairro e Complemento", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "estudou_nivel_medio_superior") },
      { key: "instituicao_endereco_cidade", label: "Cidade", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "estudou_nivel_medio_superior") },
      { key: "instituicao_endereco_estado", label: "Estado", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "estudou_nivel_medio_superior") },
      { key: "instituicao_endereco_cep", label: "Código postal", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "estudou_nivel_medio_superior") },
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "paises_visitados_5_anos", label: "Descreva todos Países Visitados no Últimos 5 Anos", kind: "textarea", optional: true, showIf: (d) => SIM_NAO(d, "viajou_ultimos_5_anos") },
    ],
  },
  {
    id: "adicionais",
    ...
    campos: [
      ...
      { key: "treinamento_arma_detalhe", label: "Explique habilidade ou Treinamento Especializado", kind: "textarea", optional: true, showIf: (d) => SIM_NAO(d, "treinamento_arma") },
      { key: "serviu_exercito", label: "Você já serviu ao Exército?", kind: "bool" },
      { key: "servico_militar_pais", label: "Selecione o País", kind: "text", optional: true, showIf: (d) => SIM_NAO(d, "serviu_exercito") },
      ...
      { key: "servico_militar_data_inicio", label: "Data Início Serviço", kind: "date", optional: true, showIf: (d) => SIM_NAO(d, "serviu_exercito") },
      { key: "servico_militar_data_fim", label: "Data Término Serviço", kind: "date", optional: true, showIf: (d) => SIM_NAO(d, "serviu_exercito") },
    ],
  },
  {
    id: "seguranca_1",
