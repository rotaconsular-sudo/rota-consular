  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-2xl px-6 py-12">
        ...
        {/* CTA — card branco, botão vermelho */}
        <aside className="mt-14 rounded-2xl border border-slate-200 bg-white p-8 text-center">
          <span className="eyebrow text-accent">Análise grátis</span>
          <p className="mx-auto mt-3 max-w-md text-balance text-lg font-bold text-ink">
          ...
          <Link
            ...
            className="mt-5 inline-block rounded-full bg-brand px-6 py-3 text-sm font-bold text-star transition hover:bg-brand-strong"
          >
